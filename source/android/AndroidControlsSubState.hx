...
class AndroidControlsSubState extends FlxSubState
{
	...
	override function create()
	{
		...
		exitButton.label.setFormat(Assets.getFont('assets/android/menu/Funkin Bold.otf').fontName, 21, FlxColor.WHITE, CENTER, true);
		...
		resetButton.label.setFormat(Assets.getFont('assets/android/menu/Funkin Bold.otf').fontName, 21, FlxColor.WHITE, CENTER, true);
		...
		funitext.setFormat(Assets.getFont('assets/android/menu/Funkin Bold.otf').fontName, 42, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE,
			FlxColor.BLACK, true);
		...
		inputvari.setFormat(Assets.getFont('assets/android/menu/Funkin Bold.otf').fontName, 42, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE,
			FlxColor.BLACK, true);
		...
		leftArrow.frames = FlxAtlasFrames.fromSparrow(Assets.getBitmapData('assets/android/menu/arrows.png'), Assets.getText('assets/android/menu/arrows.xml'));
		leftArrow.animation.addByPrefix('idle', 'arrow left');
		leftArrow.animation.play('idle');
		add(leftArrow);

		rightArrow = new FlxSprite(inputvari.x + inputvari.width + 10, inputvari.y - 25);
		rightArrow.frames = FlxAtlasFrames.fromSparrow(Assets.getBitmapData('assets/android/menu/arrows.png'), Assets.getText('assets/android/menu/arrows.xml'));
		rightArrow.animation.addByPrefix('idle', 'arrow right');
		rightArrow.animation.play('idle');
		add(rightArrow);

		rightPozition = new FlxText(10, FlxG.height - 24, 0, '', 21);
		rightPozition.setFormat(Assets.getFont('assets/android/menu/Funkin Bold.otf').fontName, 21, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE,
			FlxColor.BLACK, true);
		rightPozition.borderSize = 3;
		add(rightPozition);

		leftPozition = new FlxText(10, FlxG.height - 44, 0, '', 21);
		leftPozition.setFormat(Assets.getFont('assets/android/menu/Funkin Bold.otf').fontName, 21, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE,
			FlxColor.BLACK, true);
		leftPozition.borderSize = 3;
		add(leftPozition);

		downPozition = new FlxText(10, FlxG.height - 64, 0, '', 21);
		downPozition.setFormat(Assets.getFont('assets/android/menu/Funkin Bold.otf').fontName, 21, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE,
			FlxColor.BLACK, true);
		downPozition.borderSize = 3;
		add(downPozition);

		upPozition = new FlxText(10, FlxG.height - 84, 0, '', 21);
		upPozition.setFormat(Assets.getFont('assets/android/menu/Funkin Bold.otf').fontName, 21, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE,
			FlxColor.BLACK, true);
